...
func (x *HayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HayRequest) ProtoMessage() {}

func (x *HayRequest) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use HayRequest.ProtoReflect.Descriptor instead.
func (*HayRequest) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{0}
}

func (x *HayRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *HayResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HayResponse) ProtoMessage() {}

func (x *HayResponse) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HayResponse.ProtoReflect.Descriptor instead.
func (*HayResponse) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{1}
}

func (x *HayResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_demo_proto_rawDesc = "" +
	...
	"\vHayResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage21\n" +
	"\n" +
	"HayService\x12#\n" +
	"\x06SayHay\x12\v.HayRequest\x1a\f.HayResponseB1Z/github.com/2comjie/wali/examples/rpcdemo/pbDemob\x06proto3"
...
var file_demo_proto_goTypes = []any{
	(*HayRequest)(nil),  // 0: HayRequest
	(*HayResponse)(nil), // 1: HayResponse
}
var file_demo_proto_depIdxs = []int32{
	0, // 0: HayService.SayHay:input_type -> HayRequest
	1, // 1: HayService.SayHay:output_type -> HayResponse
