...
const file_proto_chat_chat_proto_rawDesc = "" +
	"\n" +
	"\x15proto/chat/chat.proto\x12\x11examples.rpc.chat\" \n" +
	"\n" +
	"SayRequest\x12\x12\n" +
	...
	"\vChatService\x12D\n" +
	"\x03Say\x12\x1d.examples.rpc.chat.SayRequest\x1a\x1e.examples.rpc.chat.SayResponseB;Z9github.com/2comjie/wali/examples/rpc/pb/proto/chat;chatpbb\x06proto3"
...
var file_proto_chat_chat_proto_goTypes = []any{
	(*SayRequest)(nil),  // 0: examples.rpc.chat.SayRequest
	(*SayResponse)(nil), // 1: examples.rpc.chat.SayResponse
}
var file_proto_chat_chat_proto_depIdxs = []int32{
	0, // 0: examples.rpc.chat.ChatService.Say:input_type -> examples.rpc.chat.SayRequest
	1, // 1: examples.rpc.chat.ChatService.Say:output_type -> examples.rpc.chat.SayResponse
