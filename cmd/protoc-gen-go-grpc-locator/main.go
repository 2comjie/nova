...
// PATH with the name:
//
//	protoc-gen-go-grpc-locator
//
// The 'go-grpc-locator' suffix becomes part of the argument for the protocol
// compiler, such that it can be invoked as:
//
//	protoc --go-grpc-locator_out=. path/to/file.proto
//
...
func main() {
	...
	flag.Parse()
	if *showVersion {
		fmt.Printf("protoc-gen-go-grpc-locator %v\n", version)
		return
	}
