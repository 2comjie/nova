...
// proto-gen-rpc-wali is a plugin for the Google protocol buffer compiler to
// generate Go code. Install it by building this program and making it
// accessible within your PATH with the name:
//
//	proto-gen-rpc-wali
//
// It can be used as a protoc plugin by mapping it to the desired protoc suffix:
//
//	protoc --plugin=protoc-gen-go-wali-grpc=proto-gen-rpc-wali --go-wali-grpc_out=. path/to/file.proto
//
...
func main() {
	...
	flag.Parse()
	if *showVersion {
		fmt.Printf("proto-gen-rpc-wali %v\n", version)
		return
	}
