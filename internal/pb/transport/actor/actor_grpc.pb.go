...
// versions:
// - protoc-gen-go-grpc-locator v1.1.0
// - protoc             v5.28.2
...
func (c *actorClient) Ask(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (c *actorClient) Tell(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	conn, err := c.cc.Conn(ctx)
	if err != nil {
		return nil, err
